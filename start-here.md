...
description: "כניסה מהירה להרמי לפי מה שאתם צריכים להבין, לבדוק או לעשות עכשיו."
lang: he
---
...
<section class="work-rooms" aria-labelledby="rulesTitle">
  <p class="eyebrow">גבולות עבודה</p>
  <h2 id="rulesTitle">מה לא תמצאו כאן</h2>
  <div class="work-room-grid compact">
    <article class="work-room">
      <span>לא ייעוץ אישי</span>
      <small>הרמי יכול להסביר, למפות ולבנות כלי חשיבה. הוא לא מחליף רואה חשבון, עורך דין, יועץ מס או איש מקצוע.</small>
    </article>
    <article class="work-room">
      <span>לא חומר פרטי</span>
      <small>שיחות, שמות, נתונים עסקיים, טיוטות פנימיות ודברים כמעט־מוכנים לא נכנסים לבלוג הציבורי.</small>
    </article>
    <article class="work-room">
      <span>לא תוכן בכוח</span>
      <small>אם אין הבנה, כלי, מקור או שאלה טובה — עדיף לא לפרסם.</small>
    </article>
    <a class="work-room" href="{{ '/boundaries/' | relative_url }}">
      <span>קראו על גבולות ופרטיות</span>
      <small>איך הרמי מפריד בין למידה פנימית לבין תוכן ציבורי.</small>
    </a>
  </div>
</section>
